...
class MRPCTaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'mrpc',
                                     split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/MRPC')
...
class COLATaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'cola',
                                     split=split, script_version="master", cache_dir='/mnt/liupeiyu/nlp_data/GLUE/COLA')
...
class SST2TaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'sst2',
                                     split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/SST-2')
...
class STSBTaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'stsb',
                                     split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/STS-B')
...
class QQPTaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'qqp',
                                     split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/QQP')
...
class MNLITaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'mnli', split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/MNLI')
...
class QNLITaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'qnli', 
                                        split=split, script_version="master", cache_dir='/mnt/liupeiyu/nlp_data/GLUE/QNLI')
...
class RTETaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'rte',
                                     split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/RTE')
...
class WNLITaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/mnt/liupeiyu/nlp_data/GLUE/glue.py', 'wnli', 
                                split=split, script_version="master",cache_dir='/mnt/liupeiyu/nlp_data/GLUE/WNLI')
